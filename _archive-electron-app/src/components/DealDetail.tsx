...
import { STAGES, T, fmtDealAmt, fmtYen, fmt, shortName } from '@/lib/constants';
  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', padding: '0 16px 16px' }}>
      ...
      <div style={{ display: 'flex', gap: 12, flex: 1, minHeight: 0 }}>
        ...
        {/* Center: Activity (placeholder for now) */}
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 8, padding: '14px 16px', height: '100%' }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: T.primary, marginBottom: 8 }}>アクティビティ</div>
            <div style={{ fontSize: 11, color: T.muted }}>アクティビティタイムラインは移行中です。</div>
          </div>
        </div>
